...
#        self.avg_percentage = self.allSensors.soilSensorValue[0]  # toupel auseinander nehmen
        display_text = "Bodenfreuchtigkeit:" + str(self.model.currentValues['moisture']) + "%:Temperatur:" + str(self.model.currentValues['temperature']) + chr(0)+"C:Licht:" + str(self.model.currentValues['light'])+"lux:"
